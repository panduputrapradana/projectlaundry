                ...
                <div class="container-fluid">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>admin/pesanan/simpan" method="post" enctype="multipart/form-data">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="<?= base_url('admin/pesanan'); ?>" type="submit" class="btn btn-danger btn-block" style="margin-top: 0 !important ;">Batal</a>
                                    </div>
                                    <div>
