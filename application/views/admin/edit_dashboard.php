                ...
                <div class="container-fluid">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>admin/beranda/simpan_edit" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-2 mt-2" hidden>
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $data['id_profil']; ?>" name="id_profil" placeholder="ID" value="<?php echo set_value('id_profil'); ?>" readonly>
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $data['nama']; ?>" name="nama" placeholder="Masukkan Nama Outlet" value="<?php echo set_value('nama'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <input type="text" class="form-control" id="inputEmail4" name="ig" value="<?= $data['ig']; ?>" placeholder="Masukkan username instagram (tanpa tanda @)" value="<?php echo set_value('ig'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-geo-alt-fill"></i></span>
                                        </div>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <input type="number" class="form-control" id="inputEmail4" name="wa" value="<?= $data['wa']; ?>" placeholder="Masukkan Nomor Whatsapp (08******)" value="<?php echo set_value('wa'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <input type="text" class="form-control" id="inputEmail4" name="fb" value="<?= $data['fb']; ?>" placeholder="Masukkan Link Facebook" value="<?php echo set_value('fb'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-telephone-fill"></i></span>
                                        </div>
                                ...
                                <?php echo form_error('fb', '<small class="text-danger pl-1">', '</small>'); ?>
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="<?= base_url('admin/beranda'); ?>" type="submit" class="btn btn-danger btn-block" style="margin-top: 0 !important ;">Batal</a>
                                    </div>
                                    <div>
