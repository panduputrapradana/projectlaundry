        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Tambah Karyawan</h1>
                    <div class="container">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>admin/karyawan/simpan" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-2 mt-2" hidden>
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $id_karyawan; ?>" name="id_karyawan" placeholder="ID" value="<?php echo set_value('id_karyawan'); ?>" readonly>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <select class="form-select form-select-sm" name="bagian" aria-label=".form-select-sm example">
