        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Cabang Outlet Kami</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="<?= base_url('admin/profil/tambah_profil'); ?>">
                                <h6 class="m-0 font-weight-bold text-primary"><i class="far fa-plus-square"></i> Tambah Cabang Outlet</h6>
                            </a>
                        </div>
                        <div class="container">
                        ...
                        <div class="container">
                            <?= $this->session->flashdata('epesan'); ?>
                        </div>
                        <div class="container">
                            <?= $this->session->flashdata('outletH'); ?>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody class="table-primary">
                                        ...
                                        foreach ($profil as $row) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="tombol">
                                                        <a class="btn btn-default " href="<?= base_url('admin/profil/edit/') . $row['id_outlet']; ?>">
                                                            <ion-icon><i class="far fa-edit"></i></ion-icon>
                                                        </a>
                                                        <a class="btn btn-danger" onclick="return confirm('Yakin akan menhapus outlet')" href="<?= base_url('admin/profil/hapus/') . $row['id_outlet']; ?>">
