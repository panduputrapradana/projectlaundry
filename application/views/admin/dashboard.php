                        ...
                        <div class="center text-dark">
                            <center>
                                ...
                                <span style="font-size:40px; margin-top:-40px"><b class="outlet"><?= strtoupper($data->nama); ?></b>
                                    <span style="font-size:15px; margin-top:-30px"><b><a href="<?= base_url('admin/beranda/edit/') . $data->id_profil; ?>"><i class="far fa-edit"></i></a></b></span>
                                </span><br>
                        ...
                        <div class="col-xl-3 col-md-6 mb-4">
                            <div class="card border-left-info shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Pesanan Baru
                                            </div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                                    <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><?= $total_pesanan_baru; ?></div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-auto">
