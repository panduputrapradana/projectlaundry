        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Karyawan & Staff</h1>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="<?= base_url('admin/karyawan/tambah_karyawan'); ?>">
                                <h6 class="m-0 font-weight-bold text-primary"><i class="far fa-plus-square"></i> Tambah Karyawan & Staff</h6>
                            </a>
                        </div>
                        <div class="container">
                        ...
                        <div class="container">
                            <?= $this->session->flashdata('karyawanE'); ?>
                        </div>
                        <div class="container">
                            <?= $this->session->flashdata('karyawanH'); ?>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody class="table-primary">
                                        ...
                                        foreach ($karyawan as $row) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row->tlp; ?></td>
                                                <td class="text-center"><img style="width: 40px; height: 40px;" src="<?= base_url('assets/admin/') ?><?= $row->foto; ?>"></td>
                                                <td><?= $row->role; ?></td>
                                                <td>
                                                    <div class="tombol">
                                                        <a class="btn btn-default " href="<?= base_url() ?>admin/karyawan/edit/<?= $row->id_karyawan; ?>">
                                                            <ion-icon><i class="far fa-edit"></i></ion-icon>
                                                        </a>
                                                        <a class="btn btn-danger" onclick="return confirm('Data yang sudah dihapus tidak akan memiliki akses login lagi!')" href="<?= base_url() ?>admin/karyawan/hapus/<?= $row->id_user; ?>">
