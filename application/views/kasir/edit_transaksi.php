                ...
                <div class="container-fluid">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>kasir/pesanan/simpan_edit" method="post" enctype="multipart/form-data">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" value="<?= $transaksi['total']; ?>" id="total" name="total" placeholder="Total Harga">
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-person-fill"></i></span>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="<?= base_url('kasir/pesanan/transaksi'); ?>" type="submit" class="btn btn-danger btn-block" style="margin-top: 0 !important ;">Batal</a>
                                    </div>
                                    <div>
