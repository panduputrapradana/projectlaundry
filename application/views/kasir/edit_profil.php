        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Edit Outlet</h1>
                    <div class="container">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>admin/profil/simpan_edit" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-2 mt-2">
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $profil['id_outlet']; ?>" name="id_outlet" placeholder="ID" value="<?php echo set_value('id_karyawan'); ?>" readonly>
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $profil['nama_outlet']; ?>" name="nama_outlet" placeholder="Nama Outlet" value="<?php echo set_value('nama'); ?>" required>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <input type="text" class="form-control" id="inputEmail4" name="tlp" value="<?= $profil['tlp']; ?>" placeholder="tlp" value="<?php echo set_value('tlp'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-geo-alt-fill"></i></span>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="<?= base_url('admin/profil'); ?>" type="submit" class="btn btn-danger btn-block" style="margin-top: 0 !important ;">Batal</a>
                                    </div>
                                    <div>
