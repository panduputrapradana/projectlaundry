                                        ...
                                        foreach ($transaksi as $row) { ?>
                                            <tr>
                                                ...
                                                if ($row->status == "diambil") { ?>
                                                    <td>
                                                        <a href="<?= base_url('admin/pesanan/detail/') . $row->id; ?>" class="btn btn-warning btn-sm">Detail</a>
                                                        <a href="<?= base_url('admin/pesanan/hapus/') . $row->id; ?>" onclick="return confirm('Yakin akan menghapusnya??')" class="btn btn-danger btn-sm">Hapus</a>
                                                    </td>
                                                <?php } else if ($row->status == "selesai") { ?>
                                                    <td>
                                                        <a href="<?= base_url('admin/pesanan/detail/') . $row->id; ?>" class="btn btn-warning btn-sm">Detail</a>
                                                ...
                                                <?php } else { ?>
                                                    <td>
                                                        <a href="<?= base_url('admin/pesanan/detail/') . $row->id; ?>" class="btn btn-warning btn-sm">Detail</a>
                                                        <a href="<?= base_url('admin/pesanan/edit/') . $row->id; ?>" class="btn btn-primary btn-sm">Edit</a>
                                                    </td>
                                                <?php } ?>
                                            </tr>
                                        <?php
