                ...
                <div class="container-fluid">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>kasir/pelanggan/simpan" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-2 mt-2" hidden>
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $id_member; ?>" name="id_pelanggan" placeholder="ID" value="<?php echo set_value('id_pelanggan'); ?>" readonly>
