                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="<?= base_url('admin/paket/tambah_paket'); ?>">
                                <h6 class="m-0 font-weight-bold text-primary"><i class="far fa-plus-square"></i> Tambah Paket</h6>
                            </a>
                        </div>
                        <div class="container">
                            <?= $this->session->flashdata('paket'); ?>
                        </div>
                        <div class="container">
                            <?= $this->session->flashdata('paketE'); ?>
                        </div>
                        <div class="container">
                            <?= $this->session->flashdata('paketH'); ?>
                        </div>
                        <div class="card-body">
                                    ...
                                    <tbody class="table-primary">
                                        ...
                                        foreach ($paket as $row) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="tombol">
                                                        <a class="btn btn-default " href="<?= base_url('admin/paket/edit/') ?><?= $row->id_paket; ?>">
                                                            <ion-icon><i class="far fa-edit"></i></ion-icon>
                                                        </a>
                                                        <a class="btn btn-danger" onclick="return confirm('Data yang sudah dihapus tidak akan memiliki akses login lagi!')" href="<?= base_url('admin/paket/hapus/') . $row->id_paket; ?>">
