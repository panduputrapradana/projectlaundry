                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="<?= base_url('admin/pelanggan/tambah_pelanggan'); ?>">
                                    ...
                                    <tbody class="table-primary">
                                        ...
                                        foreach ($pelanggan as $row) { ?>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div class="tombol">
                                                        <a class="btn btn-default" href="<?= base_url() ?>admin/pelanggan/edit/<?= $row->id_member; ?>">
                                                            <ion-icon><i class="far fa-edit"></i></ion-icon>
                                                        </a>
                                                        <a class="btn btn-danger" onclick="return confirm('Data yang sudah dihapus tidak akan memiliki akses login lagi!')" href="<?= base_url() ?>admin/pelanggan/hapus/<?= $row->id_user; ?>">
