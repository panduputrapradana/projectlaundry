...
<body id="page-top">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <a href="<?= base_url('kasir/pesanan'); ?>">
                                <h6 class="m-0 font-weight-bold text-primary"><i class="far fa-plus-square"></i> Tambah Pesanan</h6>
                            </a>
                        </div>
                        <div class="container">
                                        ...
                                        foreach ($transaksi as $row) { ?>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    if ($row->status == "baru") { ?>
                                                        <select name="status" class="badge badge-primary status">
                                                            ...
                                                            <option value="<?= $row->id ?>proses"> Proses</option>
                                                            <option value="<?= $row->id ?>selesai"> Selesai</option>
                                                            <option value="<?= $row->id ?>diambil"> Diambil</option>
                                                        </select>
                                                    <?php } else if ($row->status == "proses") { ?>
                                                        <select name="status" class="badge badge-info status">
                                                            <option value="<?= $row->id ?>baru"> Baru</option>
                                                ...
                                                if ($row->status == "diambil") { ?>
                                                    <td>
                                                        <a href="<?= base_url('kasir/pesanan/detail/') . $row->id; ?>" class="btn btn-warning btn-sm">Detail</a>
                                                        <a href="<?= base_url('kasir/pesanan/hapus/') . $row->id; ?>" onclick="return confirm('Yakin akan menghapusnya??')" class="btn btn-danger btn-sm">Hapus</a>
                                                    </td>
                                                <?php } else if ($row->status == "selesai") { ?>
                                                    <td>
                                                        <a href="<?= base_url('kasir/pesanan/detail/') . $row->id; ?>" class="btn btn-warning btn-sm">Detail</a>
                                                ...
                                                <?php } else { ?>
                                                    <td>
                                                        <a href="<?= base_url('kasir/pesanan/detail/') . $row->id; ?>" class="btn btn-warning btn-sm">Detail</a>
                                                        <a href="<?= base_url('kasir/pesanan/edit/') . $row->id; ?>" class="btn btn-primary btn-sm">Edit</a>
                                                    </td>
                                                <?php } ?>
                                            </tr>
                                        <?php
    ...
    <script>
        $('.status').change(function() {
            ...
            $.ajax({
                url: "<?= base_url('kasir/pesanan/update_status'); ?>",
                method: "post",
                data: {
                    id: id,
                    stt: stt
