        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Tambah Pesanan</h1>
                    <div class="container">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>kasir/pesanan/simpan" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-2 mt-2" hidden>
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $id_pesanan; ?>" name="id" placeholder="ID" value="<?php echo set_value('id'); ?>" readonly>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <select class="form-select form-select-sm" name="id_member" aria-label=".form-select-sm example" required>
                                        <option value="" selected>- Pilih Pelanggan -</option>
                                        <?php
                                        foreach ($pelanggan as $row) { ?>
                                            <option value="<?= $row->id_member ?>"><?= $row->id_member ?> - <?= $row->nama; ?></option>
                                        <?php
                                        }
                                        ?>
                                    </select>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <select class="form-select form-select-sm" name="id_outlet" aria-label=".form-select-sm example" required>
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="harga" placeholder="Harga Paket" readonly>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" onkeypress="return event.charCode >= 48 && event.charCode <=57" class="form-control" id="jumlah" name="jumlah" placeholder="Jumlah (Kg/Pcs)" value="<?php echo set_value('jumlah'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-person-fill"></i></span>
                                        </div>
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="total" name="total" placeholder="Total Harga" readonly>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-person-fill"></i></span>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="<?= base_url('kasir/pesanan'); ?>" type="submit" class="btn btn-danger btn-block" style="margin-top: 0 !important ;">Batal</a>
                                    </div>
                                    <div>
...
<script>
    $('#paket').change(function() {
        ...
        $.ajax({
            url: '<?= base_url('kasir/pesanan/getHargaPaket') ?>',
            data: {
                id_paket: id_paket
            },
            method: 'post',
