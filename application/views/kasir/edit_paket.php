        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Form Edit Paket</h1>
                    <div class="container">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>kasir/paket/simpan_edit" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-2 mt-2">
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $paket['id_paket']; ?>" name="id_paket" placeholder="ID Paket" value="<?php echo set_value('id_paket'); ?>" readonly>
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $paket['nama_paket']; ?>" name="nama_paket" placeholder="Nama Paket" value="<?php echo set_value('nama_paket'); ?>" required>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <input type="text" class="form-control" id="inputEmail4" name="harga" value="<?= $paket['harga']; ?>" placeholder="Harga" value="<?php echo set_value('harga'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-geo-alt-fill"></i></span>
                                        </div>
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="<?= base_url('kasir/paket'); ?>" type="submit" class="btn btn-danger btn-block" style="margin-top: 0 !important ;">Batal</a>
                                    </div>
                                    <div>
