                ...
                <div class="container-fluid">
                    ...
                    <div class="card col-lg-5 bg-primary">
                        <div class="card-body login-card-body">
                            ...
                            <form action="<?= base_url(); ?>admin/karyawan/simpan_edit" method="post" enctype="multipart/form-data">
                                <div class="input-group mb-2 mt-2" hidden>
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $karyawan['id_karyawan']; ?>" name="id_karyawan" placeholder="ID" value="<?php echo set_value('id_karyawan'); ?>" readonly>
                                ...
                                <div class="input-group mb-2">
                                    <input type="text" class="form-control" id="inputEmail4" value="<?= $karyawan['nama']; ?>" name="nama" placeholder="Nama Lengkap" value="<?php echo set_value('nama'); ?>" required>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <input type="text" class="form-control" id="inputEmail4" name="alamat" value="<?= $karyawan['alamat']; ?>" placeholder="Alamat" value="<?php echo set_value('alamat'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                            <span><i class="bi bi-geo-alt-fill"></i></span>
                                        </div>
                                ...
                                <div class="input-group mb-2 mt-2">
                                    <input type="number" class="form-control" id="inputEmail4" name="tlp" value="<?= $karyawan['tlp']; ?>" placeholder="No Telepon" value="<?php echo set_value('tlp'); ?>" required>
                                    <div class="input-group-append">
                                        <div class="input-group-text">
                                ...
                                <div class="d-flex justify-content-between">
                                    <div>
                                        <a href="<?= base_url('admin/karyawan'); ?>" type="submit" class="btn btn-danger btn-block" style="margin-top: 0 !important ;">Batal</a>
                                    </div>
                                    <div>
